...
4¡¢the road images are resized to 352*244 to meet the LCNN model requirement.<br>
...
### : Testing
1. download the model's weights [patchnet & lcnn](https://drive.google.com/drive/folders/1DKnVTSd9Bc5tfv2FjEJRcpy5x9ByqD4U)<br>
2¡¢you can change the path of dataset and other parameters in testwhole.py;<br>
3¡¢run testwhole.py;<br>
